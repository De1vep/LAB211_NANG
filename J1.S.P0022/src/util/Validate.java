 ...
 * @param messageErrorOutOfRange        messageErrorOutOfRange when input number out of range
 * @param messageErrorInvalidNumber     messageErrorInvalidNumber when input invalid number
